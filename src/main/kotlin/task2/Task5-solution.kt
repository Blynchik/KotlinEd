...
fun main() {
    ...
    val userStatus = checkCustomer(age, experience)

    println(userStatus)
}

fun checkCustomer(age: Int, exp: Int): String {
    return when {
        age >= 26 && exp >= 6 -> "Доступны все авто"
        age >= 21 && exp >= 2 -> "Доступны все авто кроме Audi и BMW"
